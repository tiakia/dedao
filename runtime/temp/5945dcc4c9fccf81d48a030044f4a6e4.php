<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"F:\XAMPP\htdocs\video\public/../application/admin\view\course\edit.html";i:1515568543;s:71:"F:\XAMPP\htdocs\video\public/../application/admin\view\open\header.html";i:1510306797;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8">
		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo url('course/edit_post'); ?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="radio" name="is_free" value="1" <?php if($course_info['is_free'] == 1): ?>checked="checked"<?php endif; ?>>是&nbsp;&nbsp;
						<input type="radio" name="is_free" value="0" <?php if($course_info['is_free'] == 0): ?>checked="checked"<?php endif; ?>>否
					</div>
				</div>
				<div class="control-group">
