<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/home/wwwroot/momo/public/../application/admin/view/role/add.html";i:1510306796;s:68:"/home/wwwroot/momo/public/../application/admin/view/open/header.html";i:1510306797;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo url('role/add'); ?>">添加角色</a></li>
		</ul>
		<form class="form-horizontal js-ajax-form" action="<?php echo url('role/add_post'); ?>" method="post">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="radio inline" for="active_true"><input type="radio" name="status" value="1" checked id="active_true" />启用</label>
