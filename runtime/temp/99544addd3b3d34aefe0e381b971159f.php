<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"F:\XAMPP\htdocs\video\public/../application/video\view\common\header.html";i:1515389161;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
				...
				<div class="hidden-xs">
					...
					<ul class="nav navbar-nav navbar-right">
						<?php if(\think\Cookie::get('member_name')): ?>
							<li><a href=""><?php echo \think\Cookie::get('member_name'); ?></a></li>
