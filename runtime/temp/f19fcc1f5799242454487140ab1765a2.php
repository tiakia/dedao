<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\XAMPP\htdocs\video\public/../application/admin\view\website\edit.html";i:1514951020;s:71:"F:\XAMPP\htdocs\video\public/../application/admin\view\open\header.html";i:1510306797;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo url('website/edit_post'); ?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="nav_title" value="<?php echo $nav_info['nav_title']; ?>">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="nav_url" value="<?php echo $nav_info['nav_url']; ?>">
						<span class="form-required">*</span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="nav_sort" value="<?php echo $nav_info['nav_sort']; ?>" style="width:40px;">
					</div>
				</div>
			</fieldset>
