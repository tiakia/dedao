<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\XAMPP\htdocs\video\public/../application/admin\view\article\edit.html";i:1515374113;s:71:"F:\XAMPP\htdocs\video\public/../application/admin\view\open\header.html";i:1510306797;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a>修改文章</a></li>
		</ul>
		<form action="<?php echo url('article/edit_post'); ?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span9">
					<table class="table table-bordered">
						<tr>
							<th width="80">标题</th>
							<td>
								<input type="text" style="width:400px;" name="title" id="title" required value="<?php echo $article_info['title']; ?>" placeholder="请输入标题"/>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							<th>音频地址</th>
							<td><input type="text" name="audio" id="audio" value="<?php echo $article_info['audio']; ?>" style="width: 400px" placeholder="请输入音频地址"></td>
						</tr>
						<tr>
							<th>摘要</th>
							<td>
								<textarea name="description" id="description" style="width: 98%; height: 50px;" placeholder="请填写摘要"><?php echo $article_info['description']; ?></textarea>
							</td>
						</tr>
						<tr>
							<th>内容</th>
							<td>
								<script type="text/plain" id="content" name="content"><?php echo $article_info['content']; ?></script>
							</td>
						</tr>
						<!-- <tr>
							<th>相册图集</th>
