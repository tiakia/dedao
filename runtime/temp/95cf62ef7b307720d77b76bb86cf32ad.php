<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/home/wwwroot/momo/public/../application/admin/view/version/add.html";i:1510306796;s:68:"/home/wwwroot/momo/public/../application/admin/view/open/header.html";i:1510306797;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo url('version/add'); ?>">版本添加</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo url('version/add_post'); ?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="version_code" value="">
						<span class="form-required">*</span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="download_url" value="">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">升级说明</label>
					<div class="controls">
						<textarea name="version_desc" rows="7"></textarea>
					</div>
				</div>
				<div class="control-group">
