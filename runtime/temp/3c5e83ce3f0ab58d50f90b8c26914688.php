<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"F:\XAMPP\htdocs\video\public/../application/video\view\open\header.html";i:1515476192;s:70:"F:\XAMPP\htdocs\video\public/../application/video\view\index\xima.html";i:1515638931;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="container" style="margin-top:40px;"><p style="font-family:Microsoft yahei;font-weight:bold;font-size:18px;border-left:3px solid green;" >&nbsp;<?php echo $vo['catname']; ?></p>
	<div class="img-list clearfix" style="height:530px;">
		<div class="jiemu">
			<?php if(is_array($vo['data']) || $vo['data'] instanceof \think\Collection || $vo['data'] instanceof \think\Paginator): if( count($vo['data'])==0 ) : echo "" ;else: foreach($vo['data'] as $key=>$vos): ?>
				<a href="<?php echo url('course/item',['course_id'=>$vos['course_id']]); ?>">
					<div class="col-xs-3" style="width:140px;">
						<img src="<?php echo strexists($vos['thumb'],'http')?$vos['thumb'] : '__UPLOAD__/avatar/'.$vos['thumb']; ?>">
						<div style="width:120px;"><?php echo $vos['title']; ?></div>
					</div>
				</a>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</div>	
