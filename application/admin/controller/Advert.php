...
class Advert extends Adminbase
{
    ...
    public function advert_add_post(){
        if (request()->isPost()) {
            ...
            $adv_pic = array("adv_pic"=>$info->getFilename(),"adv_pic_url"=>$param['adv_pic_url'],"adv_share_url"=>$param['adv_share_url']);
    ...
    public function advert_edit_post(){
        if (request()->isPost()) {
            ...
            $adv_pic = array("adv_pic"=>$file_name,"adv_pic_url"=>$param['adv_pic_url'],'adv_share_url'=>$param['adv_share_url']);
            $param['content'] = json_encode($adv_pic);
